...
$scl = $this->escape($this->params->get('scl',0));
$scr = $this->escape($this->params->get('scr',0));
?>
<?php if (empty($this->items)): ?>
<p><?php echo JText::_('COM_SSCHEDULE_SCWT_NOT_DATA'); ?></p>
<?php else : ?> 
<div id="soc">
...
<?php $kow = &$this->items [$i + 1]; ?>
    <?php if ($title_tmp != $item->day): ?>
        ...
        <thead>
        <tr>
            <th class="nobg"  scope="col"><?php echo JText::_('COM_SSCHEDULE_SCWT_TIME'); ?></th>
            <th scope="col"><?php echo JText::_('COM_SSCHEDULE_SCWT_LESSON'); ?></th> 
            <th scope="col"><?php echo JText::_('COM_SSCHEDULE_SCWT_CLASSROOM'); ?></th>
            <th scope="col"><?php echo JText::_('COM_SSCHEDULE_SCWT_CLASS'); ?></th>
        </tr>
        </thead>
        <tbody>
   <?php endif; ?>
